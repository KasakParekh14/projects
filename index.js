function getAnswer() {
    const selectedAnswer = document.querySelector('input[name="mcq"]:checked').value;
    const questionId = document.getElementById('question-id').value; // Assuming you store question ID somewhere
    ...
    fetch('/check_answer', {
        ...
        body: JSON.stringify({ answer: selectedAnswer, question_id: questionId })
    })
    .then(response => response.json())
    .then(data => {
        if (data.result === 'correct') {
            document.getElementById('remark').style.display = 'block';
            document.getElementById('remark').innerText = 'Correct Answer, You Can Roll The Dice';
            document.getElementById('proceed-btn').style.display = 'block';
        } else {
            document.getElementById('remark').style.display = 'block';
            document.getElementById('remark').innerText = 'Wrong Answer, You Miss Your Turn';
        }
    });
}
